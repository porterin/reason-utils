...
[@bs.module "./MomentTzTest"]
external setLocalZone: (Js.Date.t, string) => Js.Date.t = "setLocalZone";

[@bs.module "./MomentTzTest"]
external setOtherZone: (Js.Date.t, string) => Js.Date.t = "setOtherZone";

[@bs.module "./MomentTzTest"] external isValid: Moment.t => bool = "isValid";
